...
<head>
    ...
    <title>Tambah Project | Access Internship</title>
...
<body class="text-slate-600 overflow-x-hidden">
        ...
        <div
            ...
            <div class="flex items-center gap-3 min-w-0">
                ...
                <div class="min-w-0">
                    ...
                    <h1 class="text-[13px] font-bold text-navy whitespace-nowrap">
                        Access Internship
                    </h1>

                    <p class="text-[10px] text-slate-400 mt-1 whitespace-nowrap">
                        CV Access Media
                    </p>
    ...
    <main
        ...
        <header
            ...
            border-b border-slate-200 px-7
            flex items-center justify-between
            max-md:h-[70px] max-md:px-4 max-md:gap-3">
            ...
            <div class="min-w-0">
                ...
                <p
                    ...
                    Tambahkan project baru ke Access Internship
        ...
        <div
            ...
            <div class="max-w-[1050px] mx-auto">
                ...
                <section
                    ...
                    rounded-xl soft-shadow overflow-hidden">

                    <!-- FORM HEADER -->
                    <div
                        class="px-5 py-5 border-b border-slate-100
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div
                                ...
                                bg-gradient-to-br from-green-100
                                to-purple-100
                                flex items-center justify-center
                                shrink-0">
                            ...
                            <div>
                                ...
                                <p
                                    ...
                                    Lengkapi informasi project yang ingin ditambahkan.
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    <option value="Website"
                                        {{ old('jenis_project') == 'Website' ? 'selected' : '' }}>
                                        Website
                                    </option>

                                    <option value="Aplikasi"
                                        {{ old('jenis_project') == 'Aplikasi' ? 'selected' : '' }}>
                                        Aplikasi
                                    </option>

                                    <option value="Desain"
                                        {{ old('jenis_project') == 'Desain' ? 'selected' : '' }}>
                                        Desain
                                    </option>

                                    <option value="Video"
                                        {{ old('jenis_project') == 'Video' ? 'selected' : '' }}>
                                        Video
                                    </option>

                                    <option value="Lainnya"
                                        {{ old('jenis_project') == 'Lainnya' ? 'selected' : '' }}>
                                        Lainnya
                                    </option>
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    <option value="Siswa PKL"
                                        {{ old('kategori_peserta') == 'Siswa PKL' ? 'selected' : '' }}>
                                        Siswa PKL
                                    </option>

                                    <option value="Mahasiswa Magang"
                                        {{ old('kategori_peserta') == 'Mahasiswa Magang' ? 'selected' : '' }}>
                                        Mahasiswa Magang
                                    </option>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea
                                    ...
                                    focus:border-green-500
                                    focus:ring-2 focus:ring-green-100">{{ old('deskripsi') }}</textarea>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <p
                                    ...
                                    Gunakan gambar sebagai thumbnail project.
