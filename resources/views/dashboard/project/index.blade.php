...
<body class="text-slate-600 overflow-x-hidden">
    ...
    <main
        ...
        <div
            ...
            <section
                class="project-header relative overflow-hidden
                rounded-2xl border border-green-100
                bg-gradient-to-r from-[#EFFAF4] via-white
                to-[#FBF0F8] px-6 py-5 mb-6 soft-shadow">
                ...
                <div
                    ...
                    <div class="min-w-0">
                        ...
                        <p
                            ...
                            Project yang dikerjakan peserta Access Internship.
                    ...
                    <a
                        ...
                        px-4 py-2.5 rounded-lg bg-green-600
            ...
            <section
                class="project-section bg-white
                ...
                <div class="mb-5">
                    ...
                    <p
                        ...
                        Daftar project yang sedang dan telah dikerjakan peserta internship.
                ...
                <div
                    id="projectGrid"
                    class="project-grid grid grid-cols-2
